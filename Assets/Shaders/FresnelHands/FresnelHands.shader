...
Shader "Joop/FresnelHands"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Base("Base", Color) = (0,0,0,0)
		_Matellic("Matellic", Range( 0 , 1)) = 0
		_Roughnes("Roughnes", Range( 0 , 1)) = 0
		[HDR]_FresnelColor("FresnelColor", Color) = (0.9433962,0.1646493,0.1646493,0)
		_FresnelScale("FresnelScale", Range( 0 , 5)) = 1
		[ASEEnd]_FresnelPower("FresnelPower", Range( 0 , 5)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Albedo = _Base.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( _FresnelColor * fresnelNode11 ).rgb;
				float3 Specular = 0.5;
				float Metallic = _Matellic;
				float Smoothness = _Roughnes;
				float Occlusion = 1;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18800
1920;0;1920;1029;1731;325.5;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;12;-1297,350.5;Inherit;False;Property;_FresnelScale;FresnelScale;4;0;Create;True;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1230,477.5;Inherit;False;Property;_FresnelPower;FresnelPower;5;0;Create;True;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.FresnelNode;11;-983,188.5;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;17;-998,-36.5;Inherit;False;Property;_FresnelColor;FresnelColor;3;1;[HDR];Create;True;0;0;0;False;0;False;0.9433962,0.1646493,0.1646493,0;0.9433962,0.1646493,0.1646493,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;8;-562,-291.5;Inherit;False;Property;_Base;Base;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;9;-541,346.5;Inherit;False;Property;_Matellic;Matellic;1;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-552,453.5;Inherit;False;Property;_Roughnes;Roughnes;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-645,51.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=9FFD616E31E5B7C14F5D822B644844CB028B2E43